...
This documentation describes the planned cross-platform dnSpy-style decompiler built with Photino, Blazor, and `ICSharpCode.Decompiler`.
...
- [MCP implementation audit](mcp-implementation-audit.md) — current coverage, gaps, test status, and prioritized follow-up work.
